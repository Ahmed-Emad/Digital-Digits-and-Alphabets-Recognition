...
def createTrainSet() :    
    ...
    for eachNum in numbers:
        for eachVer in versions:
            ...
            # print 'intensity: ' + str(features[1])
            # print 'percentAbove: ' + str(features[2])
            # print 'percentRight: ' + str(features[3])
            # print 'YReflection: ' + str(features[4])
            # print 'XReflection: ' + str(features[5])
...
def getFeatures(array) :
    ...
    for eachRow in array:
        ...
        for eachPix in eachRow:
            ...
            k += 1
        i += 1    
    features['intensity'] = overallCounter / float(len(array) * len(array[0]))
...
def getFeaturesArr(array) :
    ...
    for eachRow in array:
        ...
        for eachPix in eachRow:
            ...
            k += 1
        i += 1    
    features.append(overallCounter / float(len(array) * len(array[0])))
